...
//double tempCsum = 0;
//double RHsum = 0;
//int tByte1, tByte2, tByte1B, tByte2B, checkSumT, checkSumTCalc;
//int rhByte1, rhByte2, rhByte1B, rhByte2B, checkSumRH, checkSumRHCalc;
//int j, rem, sumByte, fromTable;
////double tempC, tempF;
//double RH;
//int checkArr[8], toBinArr[8], binArrT[8], binArrRH[8];
//int powArr[8] = {128, 64, 32, 16, 8, 4, 2, 1};
//int powArr2[8] = {32768, 16384, 8192, 4096, 2048, 1024, 512, 256};
//int tableCRC[] = {0, 49, 98, 83, 196, 245, 166, 151, 185, 136, 219, 234, 125, 76, 31, 46, \
